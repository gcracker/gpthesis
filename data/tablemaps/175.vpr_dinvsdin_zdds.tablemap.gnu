...
set output 'figures/175vpr_dinvsdin_zddstablemap.png'
set title "175.vpr DINxRDY Unique Table with ZDDs After GC"
...
splot 'data/tablemaps/175.vpr_dinvsdin_zdds.tablemap.data' matrix
