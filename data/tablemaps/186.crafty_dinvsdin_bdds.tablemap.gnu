...
set output 'figures/186crafty_dinvsdin_bddstablemap.png'
set title "186.crafty DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/186.crafty_dinvsdin_bdds.tablemap.data' matrix
