...
set output 'figures/175vpr_dinvsdin_bddstablemap.png'
set title "175.vpr DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/175.vpr_dinvsdin_bdds.tablemap.data' matrix
