...
set output 'figures/164gzip_dinvsdin_zdds_noGCCtablemap.png'
set title "164.gzip DINxRDY Unique Table with ZDDs No GC"
...
splot 'data/tablemaps/164.gzip_dinvsdin_zdds_noGCC.tablemap.data' matrix
