...
set output 'figures/175vpr_dinvsdin_bdds_noGCCtablemap.png'
set title "175.vpr DINxDIN Unique Table with BDDs No GC"
...
splot 'data/tablemaps/175.vpr_dinvsdin_bdds_noGCC.tablemap.data' matrix
