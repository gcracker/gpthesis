...
set output 'figures/181mcf_dinvsdin_bddstablemap.png'
set title "181.mcf DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/181.mcf_dinvsdin_bdds.tablemap.data' matrix
