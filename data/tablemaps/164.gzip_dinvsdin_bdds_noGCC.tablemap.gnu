...
set output 'figures/164gzip_dinvsdin_bdds_noGCCtablemap.png'
set title "164.gzip DINxDIN Unique Table with BDDs No GC"
...
splot 'data/tablemaps/164.gzip_dinvsdin_bdds_noGCC.tablemap.data' matrix
