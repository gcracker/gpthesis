...
set output 'figures/252eon_dinvsdin_bddstablemap.png'
set title "252.eon DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/252.eon_dinvsdin_bdds.tablemap.data' matrix
