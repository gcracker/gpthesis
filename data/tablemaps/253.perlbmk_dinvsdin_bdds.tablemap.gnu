...
set output 'figures/253perlbmk_dinvsdin_bddstablemap.png'
set title "253.perlbmk DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/253.perlbmk_dinvsdin_bdds.tablemap.data' matrix
