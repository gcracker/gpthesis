...
set output 'figures/164gzip_dinvsdin_zddstablemap.png'
set title "164.gzip DINxRDY Unique Table with ZDDs After GC"
...
splot 'data/tablemaps/164.gzip_dinvsdin_zdds.tablemap.data' matrix
