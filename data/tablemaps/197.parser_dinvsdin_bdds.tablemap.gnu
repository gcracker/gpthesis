...
set output 'figures/197parser_dinvsdin_bddstablemap.png'
set title "197.parser DINxDIN Unique Table with BDDs After GC"
...
splot 'data/tablemaps/197.parser_dinvsdin_bdds.tablemap.data' matrix
